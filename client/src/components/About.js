    ...
    return (
        <div className="m-5 mx-10 max-width-full flex flex-col justify-between">
            <div className="flex justify-between shadow-lg">
                <img className="object-cover h-96 w-48 rounded-md" src={sandy_doyle} alt="Sandy & Doyle avatar"></img>
            ...
            <div className="flex justify-between shadow-lg mt-10">
                <div className="flex flex-col justify-evenly p-5">
                ...
                <img className="object-cover w-48 h-96 rounded-md" src={backyard} alt="La Junta, CO landscape"></img>
            </div>
            <div className="flex justify-between shadow-lg mt-10">
                <img className="object-cover w-48 h-96 rounded-md" src={jessica} alt="Jessica avatar"></img>
                <div className="flex flex-col justify-evenly p-5">
                    <p>Craftsy's website is designed, built, and maintained by Sandy and Doyle's daughter, Jessica.</p>
                    <Button children={
                    <div>
