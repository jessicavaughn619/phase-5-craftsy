    ...
    return (
        <div className="m-5 mx-10 max-width-full flex flex-col justify-between gap-4">
            <div className="flex flex-col justify-between shadow-lg sm:flex-row">
                <img className="object-cover h-96 w-48 rounded-md self-center sm:w-2/4" src={sandy_doyle} alt="Sandy & Doyle avatar"></img>
            ...
            <div className="flex flex-col justify-between shadow-lg sm:flex-row">
                ...
                <img className="object-cover w-48 h-96 rounded-md self-center sm:w-2/4" src={backyard} alt="La Junta, CO landscape"></img>
            </div>
            <div className="flex flex-col justify-between shadow-lg sm:flex-row">
                <img className="object-cover w-48 h-96 rounded-md self-center sm:w-2/4" src={jessica} alt="Jessica avatar"></img>
                <div className="flex flex-col justify-evenly p-5">
