                ...
                <div className="flex justify-between w-full overflow-hidden">
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="space-x-2 py-1 px-2 border rounded-lg">
                            <button onClick={handleDecrementClick} className={quantityInCart > 1 ? "cursor-pointer visible" : "invisible"}>-</button>
                            <span>{quantityInCart}</span>
                            <button onClick={handleIncrementClick} className={quantityInCart < quantity ? "cursor-pointer visible" : "invisible"}>+</button>
                        </div>
                    </div>
                </div>
            </div>
