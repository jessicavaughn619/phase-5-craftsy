export default function ProductCard({ product }) {
    const { item, description, category, price, in_stock } = product;
    return (
        <div className="max-w-sm rounded overflow-hidden shadow-lg">
            ...
            <div className="px-6 py-4">
                ...
                <div className="px-6 pt-4 pb-2 space-x-10">
                    <span className="text-gray-700 text-base">Add to Cart</span>
                    <span className="text-gray-700 text-base">Add to Wishlist</span>
                </div>
        </div>
    )
}